...
if __name__ == "__main__":
    ...
    if args.src_input_path.split('/')[-1].split('.')[-1] == 'mp4':
        ...
        print("no name:",'cp {} {}'.format(args.src_input_path, os.path.join(dst_input_path, args.src_input_path.split('/')[-1])))
    ...
    if args.src_audio_path.split('/')[-1].split('.')[-1] == 'mp3':
        ...
        print("second:",'cp {} {}'.format(args.src_audio_path, dst_audio_path))
